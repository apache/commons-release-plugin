 ...
 * which for the Apache Commons Project do not get uploaded to Nexus, and put those artifacts
...
public final class CommonsDistributionDetachmentMojo extends AbstractMojo {
    ...
    /**
     * Gets the file path for the <code>sha512</code> signature file for a given file.
     *
     ...
     *
     * @param artifact is a Maven {@link Artifact} taken from the project when the mojo starts.
     * @throws MojoExecutionException Thrown if an {@link IOException} occurs when getting the sha512 of the
     *                                artifact.
     */
    ...
    /**
     * Writes the artifacts' SHA-512 hashes to ./target/commons-release-plugin/sha512.properties.
     *
     * @throws MojoExecutionException Thrown if an {@link IOException} occurs while writing the file.
     */
