...
public final class CommonsSiteCompressionMojo extends AbstractMojo {
    ...
    /**
     * The working directory for the plugin, which is <code>target/commons-release-plugin</code> when Maven uses
     ...
     * <code>zos</code>.
     *
     * @param directoryToZip A {@link File} representing the directory containing the file to compress. Generally, this is <code>target/site</code>.
     ...
     * @throws IOException Thrown if an error occurs while adding the <code>file</code> to the ZIP archive.
     */
    ...
    /**
     * Gets all site files and adds them to the {@link CommonsSiteCompressionMojo#filesToCompress} {@link List}.
